...
# Assumption
# =============================================================================
# This code assumes you already have an OpenAI client variable named:
#
#     client
#
...
# =============================================================================
# Structured output schema for OpenAI Chat Completions
# =============================================================================
...
def tokenize_node_list(nodes: list[Any]) -> tuple[str, dict[str, Tag]]:
    ...
    def walk_node(node: Any) -> str:
        ...
        # Defensive fallback:
        # If an unexpected tag appears inside an editable run, preserve its text
...
def extract_segments(soup: BeautifulSoup) -> list[Segment]:
    ...
    This is nested-safe. It does not only process top-level blocks.
    ...
    def flush_run(parent: Tag, run_nodes: list[Any]) -> None:
        ...
        # Insert marker at the exact location of this editable run.
        run_nodes[0].insert_before(marker)

        # Remove old editable nodes from the DOM.
    ...
    while index < len(text):
        ...
        if close_match:
            ...
            if not stack:
                ...
                # Defensive recovery so we can keep checking the rest.
...
def transform_document(
    ...
    *,
    ...
    """
    Transform an HTML document string using the global OpenAI `client`.
    ...
    report = {
        ...
        "stage1_batches": len(stage1_chunks),
        "stage2_batches": 0,
        "updated_segments": 0,
        "fallback_segments": 0,
        "failed_segments": [],
    ...
    # Compute Stage 2 chunks after Stage 1, because stage1_text is now available.
